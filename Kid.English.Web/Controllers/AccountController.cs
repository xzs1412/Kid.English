...
using Kid.English.Web.Controllers.Results;
using Kid.English.Web.Models.Account;
...
{
    public class AccountController : EnglishControllerBase
    {
    ...
    /// </summary>
    public static class AbpSessionExtensions2
    {
        static readonly ConditionalWeakTable<IAbpSession, AbpSessionValue>
            _myName = new ConditionalWeakTable<IAbpSession, AbpSessionValue>();
